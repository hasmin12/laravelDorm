...
<script src="{{ secure_asset('/lib/chart/chart.min.js') }}"></script>
...
@else
<script src="{{ secure_asset('/css/style1/js/jquery-3.3.1.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/bootstrap.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/jquery.magnific-popup.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/jquery.nice-select.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/jquery-ui.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/jquery.slicknav.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/owl.carousel.min.js')}} "></script>
<script src="{{ secure_asset('/css/style1/js/main.js')}} "></script>
@endif
