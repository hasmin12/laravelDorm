    ...
    <div class="bg-light rounded p-4">
        ...
        <div class="row mb-2">
            ...
            <div id="branchDiv" class="btn-group" role="group">
                <input type="radio" class="btn-check" name="branchbtnradio" id="branchbtnradio1" autocomplete="off" checked value="Dormitory">
                <label class="btn btn-outline-primary" for="branchbtnradio1">Dormitory</label>

                <input type="radio" class="btn-check" name="branchbtnradio" id="branchbtnradio2" autocomplete="off" value="Hostel">
