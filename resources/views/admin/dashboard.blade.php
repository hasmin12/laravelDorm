                    ...
                    <ul class="swiper-wrapper list-inline m-0 p-0 mb-2">
                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                            <div class="card-body" style="text-align: center">
                                <h5 class="mb-2">Residents</h5>
                                <div class="row" style="display: flex;align-items: center;justify-content: center;">
                                    <div class="col">

                                        <div class="progress-detail">
                                            <p class="mb-2">Dormitory</p>
                                            <h4 id="numberOfDormitoryResidents" class="counter"
                                                style="visibility: visible;"></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Hostel</p>
                                            <h4 id="numberOfHostelResidents" class="counter"
                                                style="visibility: visible;"></h4>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body" style="text-align: center">
                                ...
                                <div class="row" style="display: flex;align-items: center;justify-content: center;">
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Dormitory</p>
                                            <h4 id="numberOfDormitoryRooms" class="counter"
                                                style="visibility: visible;"></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Hostel</p>
                                            <h4 id="numberOfHostelRooms" class="counter" style="visibility: visible;">
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body" style="text-align: center">
                                ...
                                <div class="row" style="display: flex;align-items: center;justify-content: center;">
                                    <div class="col">
                                        <div class="progress-detail">
                                            <p class="mb-2">Dormitory</p>
                                            <h6 id="monthlyPaymentsRevenue" class="counter"
                                                style="visibility: visible;"></h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Hostel</p>
                                            <h6 id="monthlyReservationsRevenue" class="counter"
                                                style="visibility: visible;"></h6>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body" style="text-align: center">
                                ...
                                <div class="row" style="display: flex;align-items: center;justify-content: center;">
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Dormitory</p>
                                            <h6 id="totalPaymentsRevenue" class="counter" style="visibility: visible;">
                                            </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="progress-detail">
                                            <p class="mb-2">Hostel</p>
                                            <h6 id="totalReservationsRevenue" class="counter"
                                                style="visibility: visible;"></h6>
                                        </div>
                                    </div>
                    ...
                    <div class="card" data-aos="fade-up" data-aos-delay="800">
                        <div class="card-header d-flex justify-content-between flex-wrap">
                            <div class="header-title">
                                <h4 id="totalRevenue" class="card-title"></h4>
                                <p class="mb-0">Total Revenue</p>
                            </div>

                        </div>
                        <div class="card-body">
                            <div id="totalrevenue_chart"></div>
                            <div id="chart-drag"></div>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getDashboardData() {
                fetch('/admin/getDashboardData')
                    ...
                    .then(data => {
                        // Ensure values are defined and valid before formatting
                        document.getElementById('totalPaymentsRevenue').textContent = "₱" + num_format(data
                            .totalPaymentsRevenue || 0);
                        document.getElementById('totalReservationsRevenue').textContent = "₱" + num_format(data
                            .totalReservationsRevenue || 0);
                        document.getElementById('monthlyPaymentsRevenue').textContent = "₱" + num_format(data
                            .averagePaymentsRevenue || 0);
                        document.getElementById('monthlyReservationsRevenue').textContent = "₱" + num_format(
                            data
                            .averageReservationsRevenue || 0);
                        document.getElementById('numberOfDormitoryResidents').textContent = data
                            .numberOfDormitoryResidents || 0;
                        document.getElementById('numberOfHostelResidents').textContent = data
                            .numberOfHostelResidents || 0;
                        document.getElementById('numberOfDormitoryRooms').textContent = data
                            .numberOfDormitoryRooms || 0;
                        document.getElementById('numberOfHostelRooms').textContent = data.numberOfHostelRooms ||
                            0;
                        document.getElementById('totalRevenue').textContent = "₱" + num_format(data
                            .totalRevenue ||
                            0);
                    })
            ...
            function num_format(num) {
                // Ensure num is a number and provide a default value if not
                if (typeof num === 'number' && !isNaN(num)) {
                    return num.toLocaleString("en-US", {
                        maximumFractionDigits: 2
                    });
                }
                return "0.00"; // Default value if num is not a valid number
            }


            function getTotalRevenue() {
                fetch('/admin/getTotalRevenue')
                    .then(response => response.json())
                    .then(data => {
                        // Transform the data into the format required by ApexCharts
                        const paymentsData = data.payments.map(item => ({
                            x: item.month, // Convert date to timestamp
                            y: item.totalRevenue
                        }));
                        const reservationsData = data.reservations.map(item => ({
                            x: item.month,
                            y: item.totalRevenue
                        }));
                        ...
                        const optionsLarge = {
                            ...
                            yaxis: {
                                ...
                                labels: {
                                    formatter: function(val) {
                                        ...
                                        const prefixes = ['', 'K', 'M', 'B', 'T']; // Adjust as needed
                                        for (var i = prefixes.length - 1; i >= 0; i--) {
                                            var divisor = Math.pow(10, i * 3);
                                            if (val >= divisor) {
                                                roundingFactor = divisor;
                                                break;
                                            }
                                        }
                            ...
                            legend: {
                                ...
                                fontSize: '18px', // Increase font size for legend
                                fontFamily: 'Arial, sans-serif', // Optional: set font family
                                fontWeight: 600,
                                onItemClick: {
                                    toggleDataSeries: false // Disable toggling series visibility
                                }
                            }
                        };

                        // Render the large chart
                        var chartLarge = new ApexCharts(document.querySelector("#totalrevenue_chart"),
                            optionsLarge);
                        chartLarge.render();
                        ...
                        const chart = new ApexCharts(document.querySelector("#chart-drag"), optionsSmall);
                        chart.render();
                    })
