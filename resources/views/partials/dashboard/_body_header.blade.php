            ...
            <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="sub-drop dropdown-menu dropdown-menu-end p-0" aria-labelledby="notification-drop">
                        <div class="card shadow-none m-0" style="width: 360px">
                            <div class="card-header d-flex justify-content-between bg-primary py-3">
                                <div class="header-title">
                                    <h5 class="mb-0 text-white">All Notifications</h5>
                                </div>
                            </div>
                            <div class="card-body p-0" id="notificationCard">
...
<script>
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    notificationHtml = '<p class="text-center">No notifications available.</p>';
                } else {
            ...
            <div class="d-flex align-items-center">
                <div class="ms-3 w-100">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <small class="float-right font-size-12 ms-2">${new Date(notification.created_at).toLocaleString()}</small> <!-- Added margin class -->
                    </div>
                </div>
            </div>
        </a>
    `;
                ...
                $('#notificationCard').html(notificationHtml);
            },
            error: function(xhr) {
