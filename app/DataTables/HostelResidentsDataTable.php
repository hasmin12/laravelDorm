...
class HostelResidentsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'admin.residents.hostelaction')
    ...
    {
        $model = User::query()->where('branch','Hostel')->where('user_type','user')->with('userProfile')->orderBy('created_at', 'desc');
